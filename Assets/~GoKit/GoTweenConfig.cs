...
public class GoTweenConfig
{
	...
	/// <summary>
	/// sets the number of iterations and the loop typeEnum. setting to -1 will loop infinitely
	/// </summary>
	...
	/// <summary>
	/// sets the ease typeEnum for the Tween
	/// </summary>
	...
	/// <summary>
	/// sets the update typeEnum for the Tween
	/// </summary>
