...
public abstract class AbstractTweenProperty
{
	...
	/// resorts to direct typeEnum checking
	/// </summary>
	public override bool Equals( object obj )
	{
		...
		// handle IGenericProperty comparisons which just have the property displayName checked
	...
	public virtual void init( GoTween owner )
	{
		...
		// if we dont have an easeFunction use the owners typeEnum
	...
	/// <summary>
	/// sets the ease typeEnum for this tween property
    ...
    /// <summary>
    /// each TweenProperty should override this to ensure the object is the correct typeEnum
    /// </summary>
	...
	/// subclasses should strongly typeEnum the start/end/target and handle isFrom with
