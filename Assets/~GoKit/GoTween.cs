...
public class GoTween : AbstractGoTween
{
    ...
    /// <summary>
    /// sets the ease typeEnum for all Tweens. this will overwrite the ease types for each Tween!
    /// </summary>
    ...
    public GoEaseType easeType
    {
        ...
        set
        {
            ...
            // change ease typeEnum of all existing tweens.
	...
	public override bool update( float deltaTime )
	{
		...
		if( Go.validateTargetObjectsEachTick )
		{
			...
			if( target == null || target.Equals(null) )
			{
				...
				Debug.LogWarning( "target validation failed. destroying the tween to avoid errors. Target typeEnum: " + this.targetType );
				autoRemoveOnComplete = true;
				return true;
			}
		}
